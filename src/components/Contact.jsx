...
export default function ContactForm() {
  ...
  return (
    <div className="py-20 text-center bg-base-100 text-base-content" id="contact">
      <h2 className="text-4xl md:text-5xl font-black mb-6 uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-orange-600">
        Get In Touch
      </h2>
      ...
      {/* Contact Form */}
      <form ref={form} onSubmit={sendEmail} className="max-w-2xl mx-auto space-y-6 reveal reveal-up">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <input
            ...
            required
            className="w-full p-3 rounded-lg bg-base-200 border border-base-300 text-base-content focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <input
            type="email"
            name="user_email"
