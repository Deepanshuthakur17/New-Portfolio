    ...
    return (
        ...
        >
            <div className="container mx-auto px-6 md:px-12 lg:px-20">
                <h2 className="text-4xl md:text-5xl font-black text-center mb-16 uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-blue-600">
                    Future Skills
                </h2>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-10 text-center">
                    {techs.map((tech, index) => (
                        <div
                            ...
                            className="flex flex-col items-center justify-center p-4 rounded-lg shadow-md bg-base-200 hover:scale-125 transform transition border border-base-300 reveal reveal-up"
                        >
                            <img
                                src={tech.icon}
                                alt={tech.name}
